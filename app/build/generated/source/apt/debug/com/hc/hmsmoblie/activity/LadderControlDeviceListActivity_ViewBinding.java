...
public class LadderControlDeviceListActivity_ViewBinding implements Unbinder {
  private LadderControlDeviceListActivity target;

  private View view2131296318;

  @UiThread
  public LadderControlDeviceListActivity_ViewBinding(LadderControlDeviceListActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public LadderControlDeviceListActivity_ViewBinding(final LadderControlDeviceListActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    LadderControlDeviceListActivity target = this.target;
