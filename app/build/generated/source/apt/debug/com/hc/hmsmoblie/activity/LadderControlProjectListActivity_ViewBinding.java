...
public class LadderControlProjectListActivity_ViewBinding implements Unbinder {
  private LadderControlProjectListActivity target;

  private View view2131296318;

  @UiThread
  public LadderControlProjectListActivity_ViewBinding(LadderControlProjectListActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public LadderControlProjectListActivity_ViewBinding(final LadderControlProjectListActivity target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    LadderControlProjectListActivity target = this.target;
