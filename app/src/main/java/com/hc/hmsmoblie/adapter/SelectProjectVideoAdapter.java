 ...
 public class SelectProjectVideoAdapter extends BaseItemDraggableAdapter<ProjectVideoBean.ListBean, BaseViewHolder> {
     public SelectProjectVideoAdapter(int layoutResId, ArrayList<ProjectVideoBean.ListBean> data) {
         super(layoutResId, data);
     }
     @Override
     protected void convert(BaseViewHolder helper, ProjectVideoBean.ListBean item) {
