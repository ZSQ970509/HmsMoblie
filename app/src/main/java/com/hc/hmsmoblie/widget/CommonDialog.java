...
public class CommonDialog extends Dialog {
    ...
    public static CommonDialog newInstanceSingle(Context context) {
        CommonDialog dialog = new CommonDialog(context);
        dialog.mRightBtn.setVisibility(View.GONE);
        dialog.mLeftBtn.setBackgroundResource(R.drawable.shape_white_blue);
        return dialog;
    }
    ...
    public CommonDialog setSingleBtnText(String text){
        return setLeftBtnText(text);
    }
    /**
     * 设置左侧按钮点击事件
     *
