...
public class EnvironmentSelectProjectActivity extends BaseMvpActivity<VideoSelectProjectP> implements VideoSelectProjectC.V {
    ...
    public static void newInstance(Activity activity) {
        Intent intent = new Intent(activity, EnvironmentSelectProjectActivity.class);
