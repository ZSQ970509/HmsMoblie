...
public class ImageLogProjectListActivity extends BaseMvpActivity<LadderControlProjectListP> implements LadderControlProjectListC.V {
    ...
    public static void newInstance(Activity activity) {
        Intent intent = new Intent(activity, ImageLogProjectListActivity.class);
    ...
    protected void initView(Bundle bundle) {
        ...
        mAdapter.setOnItemClickListener((BaseQuickAdapter adapter, View view, int position) ->
                ImageLogDeviceListActivity.newInstance(getActivity(), ((ProjectJson.ListBean) adapter.getItem(position)).getProjID())
        );
    }

    private void searchPro() {
        mPresenter.getProjectList(mEdtKey.getText().toString(), mPageIndex, mPageSize, ProTypeEnum.IMG_LOG.getTypeId());
    }
